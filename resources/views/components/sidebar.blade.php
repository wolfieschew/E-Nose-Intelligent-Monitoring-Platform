              ...
              <ul class="mt-4">
                  ...
                  <li class="relative px-6 py-3">
                      <span class="absolute inset-y-0 left-0 w-1 bg-teal-600 rounded-tr-lg rounded-br-lg"
                          aria-hidden="true" {{ request()->routeIs('dashboard') ? '' : 'hidden' }}>
                      </span>

                      <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150
                        hover:text-gray-800 dark:hover:text-gray-200
                        {{ request()->routeIs('dashboard') ? 'text-gray-900' : 'text-gray-500' }}"
                  ...
                  <li class="relative px-6 py-3">
                      <span class="absolute inset-y-0 left-0 w-1 bg-teal-600 rounded-tr-lg rounded-br-lg"
                          aria-hidden="true" {{ request()->routeIs('transaksi-enose') ? '' : 'hidden' }}>
                      </span>

                      <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150
                        hover:text-gray-800 dark:hover:text-gray-200
                        {{ request()->routeIs('transaksi-enose') ? 'text-gray-900' : 'text-gray-500' }}"
                          href="{{ route('transaksi-enose') }}">
                          <svg class="w-6 h-6" aria-hidden="true" fill="none" stroke-linecap="round"
                              stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                              <path
                  ...
                  <li class="relative px-6 py-3">
                      <span class="absolute inset-y-0 left-0 w-1 bg-teal-600 rounded-tr-lg rounded-br-lg"
                          aria-hidden="true" {{ request()->routeIs('transaksi-edge') ? '' : 'hidden' }}>
                      </span>

                      <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150
                        hover:text-gray-800 dark:hover:text-gray-200
                        {{ request()->routeIs('transaksi-edge') ? 'text-gray-900' : 'text-gray-500' }}"
                          href="{{ route('transaksi-edge') }}">
                          <svg class="w-6 h-6" aria-hidden="true" fill="none" stroke-linecap="round"
                              stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                              <path
                                  d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01">
                  ...
                  <li class="relative px-6 py-3">
                      <span class="absolute inset-y-0 left-0 w-1 bg-teal-600 rounded-tr-lg rounded-br-lg"
                          aria-hidden="true" {{ request()->routeIs('device') ? '' : 'hidden' }}>
                      </span>

                      <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150
                        hover:text-gray-800 dark:hover:text-gray-200
                        {{ request()->routeIs('device') ? 'text-gray-900' : 'text-gray-500' }}"
                          href="{{ route('device') }}">
      ...
      <aside class="fixed inset-y-0 z-20 flex-shrink-0 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-800 md:hidden"
          ...
          <div class="py-4 text-gray-500 dark:text-gray-400">
              ...
              <ul class="mt-4">
                  <li class="relative px-6 py-3">
                      <span class="absolute inset-y-0 left-0 w-1 bg-teal-600 rounded-tr-lg rounded-br-lg"
                          aria-hidden="true" {{ request()->routeIs('dashboard') ? '' : 'hidden' }}></span>
                  ...
                  <li class="relative px-6 py-3">
                      <span class="absolute inset-y-0 left-0 w-1 bg-teal-600 rounded-tr-lg rounded-br-lg"
                          aria-hidden="true" {{ request()->routeIs('transaksi-enose') ? '' : 'hidden' }}></span>
                      <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                          href="{{ route('transaksi-enose') }}">
                          <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke-linecap="round"
                              stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <li class="relative px-6 py-3">
                      <span class="absolute inset-y-0 left-0 w-1 bg-teal-600 rounded-tr-lg rounded-br-lg"
                          aria-hidden="true" {{ request()->routeIs('device') ? '' : 'hidden' }}></span>
                      <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                          href="{{ route('device') }}">
                          <span class="material-symbols-outlined">
                              devices
