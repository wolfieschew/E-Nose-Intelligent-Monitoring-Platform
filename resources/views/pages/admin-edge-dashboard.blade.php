                        ...
                        <h2 class="text-2xl font-semibold text-gray-700 dark:text-gray-200 flex items-center gap-2">
                            ...
                            <div x-data="{ open: false }" class="relative">
                                ...
                                <div x-show="open" @click.away="open = false" class="absolute left-0 mt-2 w-48 bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-lg shadow-lg z-10">
                                    <a href="{{ route('admin-edge-dashboard') }}" class="text-sm block px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600 bg-blue-50 dark:bg-blue-900 rounded-t-lg">Edge Dashboard</a>
                                    <a href="{{ route('admin-enose-dashboard') }}" class="text-sm block px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600 rounded-b-lg">E-Nose Dashboard</a>
                                </div>
                            </div>
                        </h2>
                    </div>
                            ...
                            <div>
                                ...
                                >
                                    @foreach ($deviceList as $device)
                                        <option
                                            value="{{ route('admin-edge-dashboard', array_merge(request()->query(), ['device_id' => $device->device_id])) }}"
                         ...
                         <div class="mb-6" x-data="{ filterOpen: false }">
                             <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                                 ...
                                 <div x-show="filterOpen" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 transform -translate-y-2" x-transition:enter-end="opacity-100 transform translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 transform translate-y-0" x-transition:leave-end="opacity-0 transform -translate-y-2" class="border-t border-gray-200 dark:border-gray-700">
                                     <form method="GET" action="{{ url('/admin-edge-dashboard') }}" class="p-4">
                                         <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
                                             ...
                                             <div class="flex items-end gap-2">
                                                 ...
                                                 @if($hasFilters ?? false)
                                                 <a href="{{ url('/admin-edge-dashboard') }}" class="flex-1 bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200 flex items-center justify-center gap-2">
                                                     <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
