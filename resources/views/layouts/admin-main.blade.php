                ...
                <div class="container px-6 mx-auto grid">
                    <div class="flex items-center justify-between my-6">
                        <h2 class="text-2xl font-semibold text-gray-700 dark:text-gray-200 flex items-center gap-2">
                            ...
                            <span>
                                {{ request()->routeIs('admin-enose-dashboard') ? 'E-Nose Dashboard' : 'Edge Dashboard' }}
                            </span>
                            <div x-data="{ open: false }" class="relative">
                                <button @click="open = !open" class="p-2 bg-gray-100 dark:bg-gray-900 rounded-md hover:bg-gray-200 dark:hover:bg-gray-600 ">
                            ...
                            <div class="p-3 mr-4 text-green-500 bg-green-100 rounded-full dark:text-green-100 dark:bg-green-500">
                                <svg class="w-6 h-6 fill-current text-green-500 dark:text-green-100" enable-background="new 0 0 64 64" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                                        ...
                                        <line stroke="currentColor" stroke-miterlimit="10" stroke-width="1.5" x1="9.1" x2="9.1" y1="43.9" y2="55.8" />
                                    </g>
                                </svg>
                            </div>
